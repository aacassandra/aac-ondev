...
!(function (t, e) {
  ...
  var et = {
    ...
    nt = {
      ...
      next: function (t, e) {
        if (t) {
          var element2 = t.nextElementSibling;
    ...
    wt = (function () {
      ...
      return (
        ...
        (i._detectNavbar = function () {
          let rxx = false;
          if (this._element) {
            rxx = Boolean(this._element.closest(".navbar"));
          }
          return rxx;
        }),
  ...
  q.on(document, "click.bs.modal.data-api", '[data-toggle="modal"]', function (
    t
  ) {
    var e = this,
      n = d(this);
